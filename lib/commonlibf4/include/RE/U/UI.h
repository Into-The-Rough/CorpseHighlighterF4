...
namespace RE
{
	...
	public:
		...
		{
			static REL::Relocation<BSReadWriteLock*> menuMapRWLock{
				ID::Runtime(578487, ID::UI::GetMenuMapRWLock)
			};
		...
		{
			static REL::Relocation<UI**> singleton{ ID::Runtime(548587, ID::UI::Singleton) };
			return *singleton;
		}
