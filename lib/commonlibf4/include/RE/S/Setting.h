...
namespace RE
{
	...
	public:
		...
		{
			static REL::Relocation<INISettingCollection**> singleton{
				ID::Runtime(791183, ID::Setting::INISettingCollection::Singleton)
			};
			return *singleton;
		}
	...
	public:
		...
		{
			static REL::Relocation<GameSettingCollection**> singleton{
				ID::Runtime(8308, ID::Setting::GameSettingCollection::Singleton)
			};
			return *singleton;
		}
