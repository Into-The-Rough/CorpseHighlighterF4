	...
	public:
		static BSPointerHandle<T> CreateHandle(T* a_ptr)
		{
			...
			static REL::Relocation<func_t> func{
				ID::Runtime(224532, ID::BSPointerHandle::BSPointerHandleManagerInterface::CreateHandle)
			};
			return func(a_ptr);
		}
		...
		static BSPointerHandle<T> GetHandle(T* a_ptr)
		{
			...
			static REL::Relocation<func_t> func{
				ID::Runtime(901626, ID::BSPointerHandle::BSPointerHandleManagerInterface::GetHandle)
			};
			return func(a_ptr);
		}
		...
		static bool GetSmartPointer(const BSPointerHandle<T>& a_in, NiPointer<T>& a_out)
		{
			...
			static REL::Relocation<func_t> func{
				ID::Runtime(967277, ID::BSPointerHandle::BSPointerHandleManagerInterface::GetSmartPointer)
			};
