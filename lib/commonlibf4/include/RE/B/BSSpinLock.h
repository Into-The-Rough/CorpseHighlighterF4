...
namespace RE
{
	...
	public:
		void lock(const char* a_id = nullptr)
		{
			...
			static REL::Relocation<func_t> func{ ID::Runtime(1425657, ID::BSSpinLock::lock) };
		...
		[[nodiscard]] bool try_lock()
		{
			...
			static REL::Relocation<func_t> func{ ID::Runtime(267930, ID::BSSpinLock::try_lock) };
			return func(this);
		}
	...
	public:
		void lock_read()
		{
			...
			static REL::Relocation<func_t> func{
				ID::Runtime(1573164, ID::BSSpinLock::BSReadWriteLock::lock_read)
			};
			return func(this);
		}
		...
		void lock_write()
		{
			...
			static REL::Relocation<func_t> func{
				ID::Runtime(336186, ID::BSSpinLock::BSReadWriteLock::lock_write)
			};
			return func(this);
		}
		...
		[[nodiscard]] bool try_lock_read()
		{
			...
			static REL::Relocation<func_t> func{
				ID::Runtime(1372435, ID::BSSpinLock::BSReadWriteLock::try_lock_read)
			};
			return func(this);
		}
		...
		[[nodiscard]] bool try_lock_write()
		{
			...
			static REL::Relocation<func_t> func{
				ID::Runtime(1279453, ID::BSSpinLock::BSReadWriteLock::try_lock_write)
			};
			return func(this);
		}
