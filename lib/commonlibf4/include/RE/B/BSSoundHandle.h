...
namespace RE
{
	...
	public:
		...
		bool IsValid()
		{
			...
			static REL::Relocation<func_t> func{ ID::Runtime(1154607, ID::BSSoundHandle::IsValid) };
			return func(this);
		}
		...
		bool Play()
		{
			...
			static REL::Relocation<func_t> func{ ID::Runtime(384073, ID::BSSoundHandle::Play) };
			return func(this);
		}
		...
		bool SetOutputModel(const BSISoundOutputModel* a_outputModel)
		{
			...
			static REL::Relocation<func_t> func{ ID::Runtime(170407, ID::BSSoundHandle::SetOutputModel) };
