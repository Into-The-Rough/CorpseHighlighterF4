...
namespace RE
{
	...
	public:
		...
		{
			static REL::Relocation<BGSSaveLoadManager**> singleton{
				ID::Runtime(1247320, ID::BGSSaveLoadManager::Singleton)
			};
			return *singleton;
		}
		...
		void QueueSaveLoadTask(QUEUED_TASK a_task)
		{
			...
			static REL::Relocation<func_t> func{
				ID::Runtime(1487308, ID::BGSSaveLoadManager::QueueSaveLoadTask)
			};
