...
namespace RE
{
	...
	public:
		...
		{
			static REL::Relocation<BSTHashMap<std::uint32_t, TESForm*>**> allForms{
				ID::Runtime(422985, ID::TESForm::AllForms)
			};
			static REL::Relocation<BSReadWriteLock*> allFormsMapLock{
				ID::Runtime(691815, ID::TESForm::AllFormsMapLock)
			};
		...
		[[nodiscard]] static auto GetAllFormsByEditorID()
			-> std::pair<
				...
				std::reference_wrapper<BSReadWriteLock>>
		{
			static REL::Relocation<BSTHashMap<BSFixedString, TESForm*>**> allFormsByEditorID{
				ID::Runtime(642758, ID::TESForm::AllFormsByEditorID)
			};
			static REL::Relocation<BSReadWriteLock*> allFormsEditorIDMapLock{
				ID::Runtime(910917, ID::TESForm::AllFormsEditorIDMapLock)
			};
