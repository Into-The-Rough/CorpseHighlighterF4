...
namespace REX::Impl
{
#ifdef F4SE_RELEASE_NO_LOG
	inline void Log(const std::source_location, const ELogLevel, const std::string_view) {}

	inline void Log(const std::source_location, const ELogLevel, const std::wstring_view) {}
